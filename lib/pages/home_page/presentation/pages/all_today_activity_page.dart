...
class AllTodayActivityPage extends ConsumerStatefulWidget {
  const AllTodayActivityPage({super.key});

  @override
  ConsumerState createState() => _AllTodayActivityPageState();
}

class _AllTodayActivityPageState extends ConsumerState<AllTodayActivityPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final todayActivity = ref.watch(todayListProvider);
        ...
        data: (data) => Padding(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) =>
                _buildActivityItem(context, todayActivity[index]),
          ),
        ),
      ),
    );
