...
class AllCompleteActivityPage extends ConsumerStatefulWidget {
  const AllCompleteActivityPage({super.key});

  @override
  ConsumerState createState() => _AllTodayActivityPageState();
}

class _AllTodayActivityPageState extends ConsumerState<AllCompleteActivityPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final historyActivity = ref.watch(historyListProvider);
      ...
      body: activityState.when(
        ...
        data: (data) => Padding(
          ...
          child: ListView.builder(
            ...
            shrinkWrap: true,
            itemCount: historyActivity.length,
            itemBuilder: (context, index) =>
                _buildActivityItem(context, historyActivity[index]),
          ),
        ),
      ),
    );
